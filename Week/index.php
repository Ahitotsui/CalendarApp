...
<?php
  ...
  //  $iniweek = date('D',strtotime("$TitleYear-$Titlemonth-$today"));
   //曜日ごとに、前月の空白マスを設定する
  //  if($iniweek == "Mon"){
  //    $ini = 0;
  //  }else if($iniweek == "Tue"){
  ...
  //  if(date('D',strtotime("$TitleYear-$Titlemonth-01")) == "Mon"){
  //    $monday_check = true;
  //  }else if(date('D',strtotime("$TitleYear-$Titlemonth-01")) == "Tue"){
  //    $loopMax = 1;
  //    $iniday = 1;
  //  }else if(date('D',strtotime("$TitleYear-$Titlemonth-01")) == "Wed"){
  //    $loopMax = 2;
  //    $iniday = 2;
  //  }else if(date('D',strtotime("$TitleYear-$Titlemonth-01")) == "Thu"){
  //    $loopMax = 3;
  //    $iniday = 3;
  //  }else if(date('D',strtotime("$TitleYear-$Titlemonth-01")) == "Fri"){
  //    $loopMax = 4;
  //    $iniday = 4;
  //  }else if(date('D',strtotime("$TitleYear-$Titlemonth-01")) == "Sat"){
  //    $loopMax = 5;
  //    $iniday = 5;
  //  }else if(date('D',strtotime("$TitleYear-$Titlemonth-01")) == "Sun"){
  //    $loopMax = 6;
  //    $iniday = 6;
  //  }
...
<main>
  ...
  <div id="topParts">
    ...
    <h2><?php print($Titlemonth); ?>月<?php print($start); ?>日〜<?php print($Titlemonth); ?>月<?php print($end); ?>日</h2>
  ...
  print("<tr>");
    ...
    if($monday_check != true && $ini != 0){
      for($i=0;$i<$loopMax;$i++){
        //前の月の日付けを空白マスの数分算出し、$prevDayDispに格納
        $prevDayDisp = ($pervMonthLast - ($iniday - 1)) + $i;
  ...
  for($i=$start;$i<=$end;$i++){
    ...
    $day++;
      ...
      if($TitleYear == $TodayYear && $TodayMonth == $Titlemonth && $today == $day){
        ...
        print("<div id=\"tdToday\"><h3 id=\"tdTodayStr\">{$i}</h3></div>");
      }else{
        print("<p class=\"tdDays\">{$day}</p>");
        print("<h3 class=\"tdDays\">{$i}</h3>");
      }
